...
class Macros {
    ...
    static public inline function RETURN_OBJ(value:Value) return RETURN_VAL(OBJ_VAL(value));
    static public inline function RETURN_NUM(value:Int) return RETURN_VAL(NUM_VAL(value));
    static public inline function BOOL_VAL(b:Bool):Value return b? {type:VAL_TRUE, as: null} : {type:VAL_FALSE, as: null};
    static public inline function AS_BOOL(value:Value) return value.type == VAL_TRUE;
    static public inline function RETURN_BOOL(value:Bool) return RETURN_VAL(BOOL_VAL(value));
     ...
     */
    public static inline function ALLOCATE<T>(vm:VM):T return cast vm.reallocate(null, 0);

    public static inline function ALLOCATE_FLEX<T1, T2>(vm:VM):T1 return cast vm.reallocate(null, 0);

    public static inline function ALLOCATE_ARRAY<T1>(vm:VM):T1 return cast vm.reallocate(null, 0);

    public static inline function DEALLOCATE<T>(vm:VM, val:T):T return cast vm.reallocate(val, 0);
